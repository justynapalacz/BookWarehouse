...
INSERT INTO book (id, title, author, category, price, total) VALUE(1, 'Dziady', 'Adam Mickiewicz', 'Classics', 50.0, 22);
INSERT INTO book (id, title, author, category, price, total) VALUE(2, 'Pan Tadeusz', 'Adam Mickiewicz', 'Classics', 45.5, 20);
INSERT INTO book (id, title, author, category, price, total) VALUE(3, 'To', 'Stephen King', 'Crime Novel', 40.0, 28);
INSERT INTO book (id, title, author, category, price, total) VALUE(4, '1984', 'George Orwell', 'Classics', 38.5, 22);
INSERT INTO book (id, title, author, category, price, total) VALUE(5, 'Dzieci z Bullerbyn', 'Astrid Lindgren', 'Children', 25.0, 10 );
INSERT INTO book (id, title, author, category, price, total) VALUE(6, 'Afryka Kazika', 'Łukasz Wierzbicki', 'Children', 20.0, 2);
INSERT INTO book (id, title, author, category, price, total) VALUE(7, 'Genesis', 'Chris Carter', 'Crime Novel', 51.0, 21);
